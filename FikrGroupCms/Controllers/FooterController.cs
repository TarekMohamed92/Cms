...
namespace FikrGroupCms.Controllers
{
    ...
    public class FooterController : Controller
    {
        ...
        public ActionResult Index(string searchString, int page = 1)
        {
            ...
            {
                int pageSize = 100;
                var data = db.ContactsTBs.ToList();
                ...
                ? (ActionResult)PartialView("_PartialContact", data.ToPagedList(page, pageSize))
        ...
        public ActionResult Edit(int id)
        {
            ...
            using (var db = new PersonalityDBEntities())
            {
                var data = db.ContactsTBs.Find(id);
                return View(data);
            }

        }
        [HttpPost, ValidateInput(false)]
        public ActionResult Edit(ContactsTB modelTb, HttpPostedFileBase file)
        {
            string abPath = "";
            using (var db = new PersonalityDBEntities())
            {
